...
options = '-both tc=0:5+0.05 proto=uci restart=on option.Threads=1 option.Hash=128 option.Ponder=false option.OwnBook=false dir=.. book=./varied.bin -recover -resign 5 500'
