...
void Position::do_move(Move m, StateInfo& newSt, const CheckInfo& ci, bool moveIsCheck) {
  ...
  // Copy some fields of the old state to our new StateInfo object (except the ones
  // which are going to be recalculated from scratch anyway) and then switch our state
...
/// and the endgame. These functions are used to initialize the incremental
...
/// material value for the given side. Material values are updated
