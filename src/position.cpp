...
/// Position::check_blockers() returns a bitboard of all the pieces with 
/// color 'c' that are blocking check on the king with color 'kingColor'.
/// A piece blocks check if removing the that piece from the board would result
/// in a position where the king is in check.
