...
const Score Bonus[VARIANT_NB][PIECE_TYPE_NB][RANK_NB][int(FILE_NB) / 2] = {
...
#ifdef RACE
  {
    ...
    { // Knight
      { S(-195,-110), S(-66,-90), S(-42,-50), S(-29,-13) },
      { S( -52, -54), S( -7,-40), S( 15,-14), S( 24, 23) },
      { S(   9, -35), S( 57,-18), S( 76, 12), S( 91, 47) },
      { S(   4, -16), S( 46,  5), S( 68, 32), S( 80, 71) },
      { S(  15,  -1), S( 58, 15), S( 83, 47), S( 87, 78) },
      { S( -21,   0), S( 28, 11), S( 50, 42), S( 59, 78) },
      { S( -23,  -9), S( 17,  5), S( 39, 43), S( 50, 69) },
      { S( -73, -27), S(-26,-12), S(-10, 24), S( -3, 56) }
    },
    { // Bishop
      { S(-45,-65), S(-21,-42), S(-29,-46), S(-39,-27) },
